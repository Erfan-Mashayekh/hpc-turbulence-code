#ifndef __PARALLEL_MANAGERS_TURBULENT_PARALLEL_MANAGER_HPP__
#define __PARALLEL_MANAGERS_TURBULENT_PARALLEL_MANAGER_HPP__
...
#endif // __PARALLEL_MANAGERS_TURBULENT_PARALLEL_MANAGER_HPP__
