#ifndef __STENCILS_MAX_U_STENCIL_HPP__
#define __STENCILS_MAX_U_STENCIL_HPP__
...
private:
    FLOAT maxValues_[3]; //! Stores the maximum module of every component
...
#endif // __STENCILS_MAX_U_STENCIL_HPP__
